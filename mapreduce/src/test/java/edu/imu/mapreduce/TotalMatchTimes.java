...
import edu.imu.mapreduce.mr.TotalMatchTimesMapper;
import edu.imu.mapreduce.mr.TotalMatchTimesReducer;
...
public class TotalMatchTimes {
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(TotalMatchTimes.class);
        //本次job作业使用的mapper类是那个？
        job.setMapperClass(TotalMatchTimesMapper.class);
        //本次job作业使用的reducer类是那个
        job.setReducerClass(TotalMatchTimesReducer.class);
