...
import edu.imu.mapreduce.mr.MatchWinrateMapper;
import edu.imu.mapreduce.mr.MatchWinrateReduce;
...
public class MatchWinrate {
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(MatchWinrate.class);
        //本次job作业使用的mapper类是那个？
        job.setMapperClass(MatchWinrateMapper.class);
        //本次job作业使用的reducer类是那个
        job.setReducerClass(MatchWinrateReduce.class);
